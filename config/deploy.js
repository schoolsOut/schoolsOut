...
module.exports = function(deployTarget) {
  ...
  if (deployTarget === 'staging') {
    ...
    ENV["fastboot-s3"].accessKeyId = process.env.ASSETS_STAGING_AWS_KEY;
    ENV["fastboot-s3"].secretAccessKey = process.env.ASSETS_STAGING_AWS_SECRET;
    ENV["fastboot-s3"].bucket = process.env.ASSETS_STAGING_BUCKET;
    ENV["fastboot-s3"].region = process.env.ASSETS_STAGING_REGION;
  }
  ...
  if (deployTarget === 'production') {
    ...
    ENV["fastboot-s3"].accessKeyId = process.env.ASSETS_PRODUCTION_AWS_KEY;
    ENV["fastboot-s3"].secretAccessKey = process.env.ASSETS_PRODUCTION_AWS_SECRET;
    ENV["fastboot-s3"].bucket = process.env.ASSETS_PRODUCTION_BUCKET;
    ENV["fastboot-s3"].region = process.env.ASSETS_PRODUCTION_REGION;
  }
